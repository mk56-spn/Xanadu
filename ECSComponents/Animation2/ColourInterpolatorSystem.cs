...
namespace XanaduProject.ECSComponents.Animation2
{
	public class ColourInterpolatorSystem(EntityStore entityStore) : QuerySystem
	{
		...
		{
			entityStore.Query<FloatArrayEcs, ColorArrayEcs>()
				.WithoutAllComponents(ComponentTypes.Get<ActiveColourEcs>())
				.ForEachEntity((ref FloatArrayEcs component1, ref ColorArrayEcs component2, Entity entity) =>
				{
