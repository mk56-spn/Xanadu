...
{
    public class TriangleArrayRefresh : BaseRefreshSystem<TriangleArrayEcs>
    {
            ...
            out Color[] colors)
        {
            ...
            var colorA = new Color(1.0f, 0.2f, 0.2f); // Reddish
            var colorB = colorA.Darkened(0.3f); // Greenish
            ...
            for (int i = 0; i < sides; i++)
            {
                ...
                var chosenColor = i % 2 == 0 ? colorA : colorB;
